document.addEventListener('DOMContentLoaded', () => {
  ...
  const imageLoadDelayInput = document.getElementById('imageLoadDelay');
  ...
  saveSettingsBtn.addEventListener('click', async () => {
    const newSettings = {
      ...
      imageLoadDelay: parseInt(imageLoadDelayInput.value, 10)
    };
  ...
  async function loadAndDisplaySettings() {
    ...
    imageLoadDelayInput.value = settings.imageLoadDelay;
  }
